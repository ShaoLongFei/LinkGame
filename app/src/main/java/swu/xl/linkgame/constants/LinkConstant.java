package swu.xl.linkgame.constants;
...
public class LinkConstant {
     ...
     * 连连看图标
     */
    public static final int[] ANIMAL_RESOURCE = {
    ...
    // 木头图标
    public static final int ANIMAL_WOOD = R.drawable.animal_no;

    /**
     * 连连看图标背景
     */
    public static final int ANIMAL_BG = R.drawable.animal_bg1;
    public static final int ANIMAL_SELECT_BG = R.drawable.animal_select_bg1;
     ...
     * 1~∞：神奇宝贝图片
     */
    public static final int[][] board_test1 = {
            {0, 0, 0, 0, 0, 0},
            {0, 1, 2, 3, 4, 0},
            {0, 2, 4, 1, 4, 0},
            {0, 3, 1, 3, 2, 0},
    ...
    public static final int[][] board_test2 = {
            {0, 0, 0, 0, 0, 0},
            {0, 1, 0, 3, 4, 0},
            {0, 2, 0, 1, 4, 0},
            {0, 3, 1, 3, 2, 0},
    ...
    public static final int[][] board_test3 = {
            {0, 0, 0, 0, 0, 0},
            {0, 0, 0, 3, 4, 0},
            {0, 0, 4, 1, 4, 0},
            {0, 3, 1, 3, 2, 0},
     ...
     * 连连看正式模板-普通
     */
    public static final int[][][] BOARD_NORMAL = {
     ...
     * 连连看正式模板-困难
     */
    public static final int[][][] BOARD_HARD = {
