...
import swu.xl.linkgame.model.PropMode;
import swu.xl.linkgame.fragment.PauseFragment;
import swu.xl.linkgame.constants.LinkConstant;
import swu.xl.linkgame.manager.LinkManager;
import swu.xl.linkgame.model.LinkInfo;
import swu.xl.linkgame.view.AnimalView;
import swu.xl.linkgame.view.XLRelativeLayout;
import swu.xl.linkgame.utils.AnimalSearchUtil;
...
import swu.xl.linkgame.utils.PxUtil;
import swu.xl.linkgame.utils.ScreenUtil;
...
public class LinkActivity extends BaseActivity implements View.OnClickListener, LinkManager.LinkGame {
    ...
    private void initView() {
        ...
        time_circle_progress.post(() -> {
            ...
            // 监听触摸事件
            link_layout.setOnTouchListener((v, event) -> {
                // 获取触摸点相对于布局的坐标
